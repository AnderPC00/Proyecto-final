...
CREATE TABLE `producto_variantes` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `producto_variante_unica` (`producto_id`,`color`,`capacidad`),
  CONSTRAINT `producto_variantes_ibfk_1` FOREIGN KEY (`producto_id`) REFERENCES `productos` (`id`)
...
INSERT INTO `producto_variantes` VALUES (1,1,'Negro','128GB',0,NULL),(2,1,'Blanco','128GB',0,NULL),(3,1,'Negro','256GB',0,NULL),(4,1,'Blanco','256GB',0,NULL),(5,2,'Blanco','256GB',5,NULL),(6,2,'Negro','128GB',1,NULL),(7,2,'Dorado','128GB',0,NULL);
